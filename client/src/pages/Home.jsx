...
export default function Home() {
  ...
  useEffect(() => {
    ...
    console.log(import.meta.env.VITE_APP_SERVER_URL);
      try {
        const res = await fetch(`${import.meta.env.VITE_APP_SERVER_URL}/api/listing/get?offer=true&limit=4`,{credentials:'include',});
    ...
    const fetchRentListings = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_APP_SERVER_URL}/api/listing/get?type=rent&limit=4`,{credentials:'include',});
        const data = await res.json();
    ...
    const fetchSaleListings = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_APP_SERVER_URL}/api/listing/get?type=sale&limit=4`,{credentials:'include',});
        const data = await res.json();
